...
init_ee_pose_2 = [-0.0597   -0.1914    0.6397];
...
for i = 1: 6
    init_cond_regress(25 + (i-1) * 6 ) = ur5.links(1,i).I(1,1)*par;
    init_cond_regress(26 + (i-1) * 6 ) = ur5.links(1,i).I(1,2)*par;
    init_cond_regress(27 + (i-1) * 6 ) = ur5.links(1,i).I(1,3)*par;
    init_cond_regress(28 + (i-1) * 6 ) = ur5.links(1,i).I(2,2)*par;
    init_cond_regress(29 + (i-1) * 6 ) = ur5.links(1,i).I(2,3)*par;
    init_cond_regress(30 + (i-1) * 6 ) = ur5.links(1,i).I(3,3)*par;
end
